...
public:
    ...
    {
        // dhg: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // dhg: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // dhg: two types of block: proof-of-work or proof-of-stake
    ...
    // dhg: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // dhg: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // dhg: block index flags
    enum  
    {
