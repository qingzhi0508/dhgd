...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "getencryptstatus",       &getencryptstatus,       true,      false,     false },
    { "frontendlogin",          &frontendlogin,          true,      false,     false },
    { "getrawmempool",          &getrawmempool,          true,      false,     false },
    { "getblock",               &getblock,               false,     false,     false },
    { "getblockbynumber",       &getblockbynumber,       false,     false,     false },
    { "getlatestblocks",        &getlatestblocks,        false,     false,     false },
    ...
    { "exploreranalysis",       &exploreranalysis,       true,      false,     false },
    { "validatepubkey",         &validatepubkey,         true,      false,     false },
    { "verifymessage",          &verifymessage,          false,     false,     false },

#ifdef ENABLE_WALLET
    { "setforgeblock",                &setforgeblock,                true,      false,     false},
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("%s, you must set a rpcpassword in the configuration file:\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"dhg Alert\" admin@foo.com\n"),
                strWhatAmI,
